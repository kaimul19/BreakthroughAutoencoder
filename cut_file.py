...
data_subset = data[0:10000].copy()

# Path to overwrite the original memmap file
output_path = 'generated_data/first_10000_raw_data.npy'  # or whatever the original file is
...
shape_path = 'generated_data/first_10000_raw_data_shape.npy'
